        ...
        with st.expander(f"{subtask_id}:\n{subtask}"):
            ...
            while n < chat_turn_limit:
                ...
                if assistant_response.terminated:
                    st.warning(
                        f"Warning: {ai_assistant_role} terminated. Reason: "
                        f"{assistant_response.info['termination_reasons']}.")
                    break
                if user_response.terminated:
                    st.warning(f"Warning: {ai_user_role} terminated. Reason: "
            ...
            insights_instruction = ("The CONTEXT TEXT is the steps to "
                                    "resolve the TASK. The INSIGHTs should "
                                    "come solely from the assistant's "
